...
function lvMain() {
var idPlayer, temp, tempNum, playerVID, playerDLURL, playerData, playerDLURL;
...
function dynamicparts(data) {

(function (obj) {
	var key, contentbox, contentSize, temp, i, contentURL;
	for(var key in obj) {
